/*
  ...
  1. Changes
    - Insert default images for each mentor in the mentor_media table
    - Uses professional stock photos from Pexels
    - Each mentor gets 3 default images

  2. Implementation
    - Uses a function to automatically add images for all mentors
