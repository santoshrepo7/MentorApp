/*
  # Add new subcategories for Career and Education

  1. Changes
    - Add 20 new subcategories for Career category
    - Add 20 new subcategories for Education category

  2. Implementation Details
    - Insert new subcategories with descriptive names and details
    - Link to existing category IDs
*/
