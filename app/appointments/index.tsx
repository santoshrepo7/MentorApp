      ...
      <View style={[styles.appointmentCard, { backgroundColor: theme.colors.card }]}>
        ...
        <View style={[styles.actionButtons, { borderTopColor: theme.colors.border }]}>
          {item.status === 'pending' && isMentor && !updating && (
            <>
              <TouchableOpacity
                style={[styles.actionButton, styles.confirmButton, { backgroundColor: theme.colors.success }]}
              ...
              <TouchableOpacity
                ...
                <Text style={[styles.actionButtonText, styles.cancelButtonText, { color: theme.colors.error }]}>
                  Cancel
                </Text>
              </TouchableOpacity>
            </>
